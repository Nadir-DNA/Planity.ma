...
export const MOCK_SALONS: MockSalon[] = [
  // ===== CASABLANCA =====
  {
    ...
    photos: [{"id": "se-1", "url": "https://images.unsplash.com/photo-1562322140-8baeececf3df?w=800&h=600&fit=crop", "alt": "Intérieur salon", "order": 0}, {"id": "se-2", "url": "https://images.unsplash.com/photo-1560066984-138dadb4c035?w=800&h=600&fit=crop", "alt": "Station de travail", "order": 1}, {"id": "se-3", "url": "https://images.unsplash.com/photo-1562322140-8baeececf3df?w=800&h=600&fit=crop", "alt": "Salle de soin", "order": 2}],
    isActive: true,
    isVerified: true,
    averageRating: 4.8,
    reviewCount: 124,
  ...
  },
  {
    ...
    photos: [{"id": "bh-1", "url": "https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=800&h=600&fit=crop", "alt": "Barbier", "order": 0}, {"id": "bh-2", "url": "https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=800&h=600&fit=crop", "alt": "Intérieur", "order": 1}],
    isActive: true,
    isVerified: true,
    averageRating: 4.9,
    reviewCount: 89,
  ...
  },
  {
    ...
    coverImage: "https://images.unsplash.com/photo-1559599238-308793637427?w=1200&h=800&fit=crop",
    photos: [{"id": "sz-1", "url": "https://images.unsplash.com/photo-1559599238-308793637427?w=800&h=600&fit=crop", "alt": "Spa", "order": 0}, {"id": "sz-2", "url": "https://images.unsplash.com/photo-1562322140-8baeececf3df?w=800&h=600&fit=crop", "alt": "Massage", "order": 1}],
    isActive: true,
    isVerified: true,
    averageRating: 4.7,
    reviewCount: 201,
  ...
  },
  {
    ...
    coverImage: "https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=1200&h=800&fit=crop",
    photos: [{"id": "bl-1", "url": "https://images.unsplash.com/photo-1562322140-8baeececf3df?w=800&h=600&fit=crop", "alt": "Beauté", "order": 0}],
    isActive: true,
    isVerified: true,
    averageRating: 4.6,
    reviewCount: 156,
  ...
  // ===== FÈS =====
  {
    ...
    coverImage: "https://images.unsplash.com/photo-1560066984-138dadb4c035?w=1200&h=800&fit=crop",
    photos: [{"id": "cf-1", "url": "https://images.unsplash.com/photo-1560066984-138dadb4c035?w=800&h=600&fit=crop", "alt": "Coiffure", "order": 0}, {"id": "cf-2", "url": "https://images.unsplash.com/photo-1560066984-138dadb4c035?w=800&h=600&fit=crop", "alt": "Salon", "order": 1}],
    isActive: true,
    isVerified: true,
    averageRating: 4.5,
    reviewCount: 67,
  ...
  // ===== AGADIR =====
  {
    ...
    photos: [{"id": "os-1", "url": "https://images.unsplash.com/photo-1562322140-8baeececf3df?w=800&h=600&fit=crop", "alt": "Spa mer", "order": 0}, {"id": "os-2", "url": "https://images.unsplash.com/photo-1559599238-308793637427?w=800&h=600&fit=crop", "alt": "Soins", "order": 1}],
    isActive: true,
    isVerified: true,
    averageRating: 4.9,
    reviewCount: 143,
  ...
  // ===== TANGER =====
  {
    ...
    coverImage: "https://images.unsplash.com/photo-1562322140-8baeececf3df?w=1200&h=800&fit=crop",
    photos: [{"id": "mbe-1", "url": "https://images.unsplash.com/photo-1562322140-8baeececf3df?w=800&h=600&fit=crop", "alt": "Massage", "order": 0}],
    isActive: true,
    isVerified: true,
    averageRating: 4.8,
    reviewCount: 112,
  ...
  // ===== CASABLANCA BARBIER =====
  {
    ...
    coverImage: "https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=1200&h=800&fit=crop",
    photos: [{"id": "gb-1", "url": "https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=800&h=600&fit=crop", "alt": "Barbier", "order": 0}, {"id": "gb-2", "url": "https://images.unsplash.com/photo-1505691938895-1758d7feb511?w=800&h=600&fit=crop", "alt": "Fauteuil", "order": 1}],
    isActive: true,
    isVerified: true,
    averageRating: 4.7,
    reviewCount: 134,
