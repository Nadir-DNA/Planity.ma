...
import { SalonActivationBanner } from "@/components/shared/salon-activation-banner";
    ...
    <div className="flex h-screen bg-[#f9f9f9]">
      ...
      >
        ...
        <div className="p-4 border-b border-[rgba(198,198,198,0.2)]">
          <div className="w-full flex items-center justify-between p-2 rounded-md bg-[#f9f9f9] text-sm">
            <div className="text-left">
              <p className="font-medium text-black">{salon.name}</p>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="flex h-16 items-center justify-between px-4 sm:px-6 bg-white border-b border-[rgba(198,198,198,0.2)]">
          ...
          <div className="flex items-center space-x-3">
            <Link
              href={salon.slug ? `/etablissement/${salon.slug}` : "/"}
